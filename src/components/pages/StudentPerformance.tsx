...
import { TrendingUp, TrendingDown, Award, Target, BookOpen, BarChart3, Calendar, AlertTriangle } from 'lucide-react';
    ...
    recommendations: [
      {
        ...
        description: 'Continue your strong performance in laboratory work and theoretical understanding.',
        action: 'Consider advanced science projects'
      },
      {
        type: 'improvement',
        title: 'Focus on English Writing Skills',
        description: 'Your reading comprehension is strong, but essay writing needs attention.',
        action: 'Practice daily writing exercises'
      },
      {
        type: 'opportunity',
        title: 'Leadership Potential',
        description: 'Your consistent performance shows leadership qualities.',
        action: 'Consider joining student council'
      }
    ]
  };
  ...
  const subjectAnalysis = [
    {
      ...
      recommendation: 'Focus on geometric concepts and practice word problems daily.'
    },
    {
      subject: 'English',
      currentGrade: 86,
      ...
      recommendation: 'Improve essay structure and practice grammar exercises.'
    },
    {
      subject: 'Science',
      currentGrade: 92,
      ...
      recommendation: 'Continue excellent lab work, review physics fundamentals.'
    }
  ];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Analyze your academic progress and get personalized insights.</p>
      </div>
            ...
            <div className="p-4 bg-green-50 rounded-lg">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-700">You're in the top 30% of your class</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 bg-blue-50 rounded-lg">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700">Your grades have improved by 5% this quarter</p>
                </div>
              </div>
            </div>
              ...
              <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700">{subject.recommendation}</p>
                    <p className="text-xs text-blue-600 mt-1">Next assessment: {subject.nextAssessment}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div key={index} className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow duration-200">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <button className="text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded-full hover:bg-blue-200 transition duration-200">
                    {rec.action}
                  </button>
                </div>
              </div>
